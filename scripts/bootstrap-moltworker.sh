...
echo "Recommended fast path:"
echo "bash /Applications/clawstudy/scripts/setup-low-cost-moltworker.sh"
echo ""
echo "Manual path (interactive):"
echo ""
echo "cd $MOLT_DIR"
...
echo "npx wrangler secret put CF_AI_GATEWAY_ACCOUNT_ID"
echo "npx wrangler secret put CF_AI_GATEWAY_GATEWAY_ID"
echo "npx wrangler secret put CLOUDFLARE_AI_GATEWAY_API_KEY"
echo "npx wrangler secret put CF_AI_GATEWAY_MODEL"
echo ""
echo "Alternative direct provider path:"
